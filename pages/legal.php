    ...
    <body class="content">
        ...
        <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="nav-cards">
                <h2>End-User License Agreement (EULA) of Pharmacompendium</h2>
                <br>
                <p>This End-User License Agreement ("EULA") is a legal agreement between you and Pescaru Softwares</p>
                <br>
                <p>This EULA agreement governs your acquisition and use of our Pharmacompendium software ("Software") directly from Pescaru Softwares or indirectly through a Pescaru Softwares authorized reseller or distributor (a "Reseller").</p>
                <br>
                <p>Please read this EULA agreement carefully before completing the installation process and using the Pharmacompendium software. It provides a license to use the Pharmacompendium software and contains warranty information and liability disclaimers.</p>
                <br>
                <p>If you register for a free trial of the Pharmacompendium software, this EULA agreement will also govern that trial. By clicking "accept" or installing and/or using the Pharmacompendium software, you are confirming your acceptance of the Software and agreeing to become bound by the terms of this EULA agreement.</p>
                <br>
                <p>If you are entering into this EULA agreement on behalf of a company or other legal entity, you represent that you have the authority to bind such entity and its affiliates to these terms and conditions. If you do not have such authority or if you do not agree with the terms and conditions of this EULA agreement, do not install or use the Software, and you must not accept this EULA agreement.</p>
                <br>
                <p>This EULA agreement shall apply only to the Software supplied by Pescaru Softwares herewith regardless of whether other software is referred to or described herein. The terms also apply to any Pescaru Softwares updates, supplements, Internet-based services, and support services for the Software, unless other terms accompany those items on delivery. If so, those terms apply. This EULA was created by EULA Template for Pharmacompendium.</p>
                <br>
                <h3>License Grant</h3>
                <p>Pescaru Softwares hereby grants you a personal, non-transferable, non-exclusive licence to use the Pharmacompendium software on your devices in accordance with the terms of this EULA agreement.</p>
                <br>
                <p>You are permitted to load the Pharmacompendium software (for example a PC, laptop, mobile or tablet) under your control. You are responsible for ensuring your device meets the minimum requirements of the Pharmacompendium software.</p>
                <br>
