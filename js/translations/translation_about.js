...
var language = {
    eng:{
        ...
        about_text_5: "Welcome to the pharmacy compendium, your number one source for all informations related to pharmaceutical products. We're dedicated to providing you the very best of pharmaceutical knowledge, with an emphasis on reliability, precision and information.",

        about_text_6: "Founded in 2019 by Pescaru Softwares, the pharmacy compendium has come a long way from its beginnings. When Pescaru Softwares first started out, the passion for world wide pharmaceutical knowledge drove them to start this website.",
    ...
    fr:{
        ...
        about_text_5: "Bienvenue au compendium pharmaceutique, votre source numéro un pour toutes les informations relatives aux produits pharmaceutiques. Nous nous engageons à vous fournir le meilleur des connaissances pharmaceutiques, en mettant l'accent sur la fiabilité, la précision et l'information.",

        about_text_6: "Fondée en 2019 par Pescaru Softwares, le compendium pharmaceutique a parcouru un long chemin depuis ses débuts. Lorsque Pescaru Softwares a commencé, la passion pour la connaissance pharmaceutique mondiale les a poussés à créer ce site Web.",
    ...
    es:{
        ...
        about_text_5: "Bienvenido a el pharmacy compendium, su fuente número uno para toda la información farmacéutica. Estamos comprometidos a brindarle lo mejor en conocimiento farmacéutico, con énfasis en la confiabilidad, precisión e información.",

        about_text_6: "Fundado en 2019 por Pescaru Softwares, el pharmacy compendium ha recorrido un largo camino desde su inicio. Cuando comenzó el software Pescaru, la pasión por el conocimiento farmacéutico global los llevó a crear este sitio web.",
